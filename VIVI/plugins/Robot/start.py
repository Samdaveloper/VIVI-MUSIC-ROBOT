...
from VIVI import Telegram, YouTube, app
from VIVI.misc import SUDOERS
from VIVI.plugins.Robot.playlist import del_plist_msg
from VIVI.plugins.Robot.sudoers import sudoers_list
from VIVI.utils.database import (add_served_chat,
                                       add_served_user,
                                       blacklisted_chats,
...
async def start_comm(client, message: Message, _):
    ...
    if len(message.text.split()) > 1:
        ...
        if name[0:4] == "help":
            ...
            await message.reply_sticker("CAACAgUAAx0CXoHSygACLgVjG050-FVJ082-3oEKKsnkNhAWuAACUgYAAiKh4FQNfnhu3RsQaR4E")
...
💖 sᴇᴀʀᴄʜ ᴩᴏᴡᴇʀᴇᴅ ʙʏ {config.MUSIC_BOT_NAME}"""
            key = InlineKeyboardMarkup(
                [
                    [
                        ...
                        InlineKeyboardButton(
                            text="• sᴜᴩᴩᴏʀᴛ •", url="https://t.me/WoFBotsSupport"
                        ),
                    ],
                ]
            )
        ...
        if config.START_IMG_URL:
            try:
                await message.reply_sticker("CAACAgUAAx0CXoHSygACLgFjG04iWOIPflIQ7w5Ts9wjzqZAcwACvgYAArmZ2VRdl4hkHpDanR4E")
