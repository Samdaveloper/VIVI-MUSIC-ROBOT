...
LOG_GROUP_ID = int(getenv("LOG_GROUP_ID", "-1001820069021"))

MUSIC_BOT_NAME = getenv("MUSIC_BOT_NAME", "🆃ҽαɱ 🅲σԃҽɾ 🅼υʂιƈ")

OWNER_ID = list(
    map(int, getenv("OWNER_ID", "6063904500").split())
)
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/Noobxcoders/VIVI-MUSIC-ROBOT",
)
...
GITHUB_REPO = getenv("GITHUB_REPO", "https://github.com/Noobxcoders/VIVI-MUSIC-ROBOT")
