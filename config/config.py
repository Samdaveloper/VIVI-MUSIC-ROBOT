...
API_ID = int(getenv("API_ID", "api I'd daal"))
API_HASH = getenv("API_HASH","hash daal")

BOT_TOKEN = getenv("BOT_TOKEN","token daal")

MONGO_DB_URI = getenv("MONGO_DB_URI","mongo db url daal")
